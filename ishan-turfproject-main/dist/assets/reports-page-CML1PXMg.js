import{a as e}from"./rolldown-runtime-CNC7AqOf.js";import{_ as t}from"./charts-DmA1CST9.js";import{Ht as n,gt as r,mt as i,nn as a,qt as o,xn as s}from"./react-vendor-C5EV9jUl.js";import{a as c,i as l,n as u,s as d,t as f}from"./card-DBuxX5j_.js";import{g as p,i as m,l as h,n as g,o as _,p as v}from"./index-BSm29Ac-.js";import{d as y,l as b,u as x}from"./accounts-service-r9_UN39s.js";import{i as S,r as C,t as w}from"./tabs-EWZkJnmV.js";import{n as T}from"./customers-service-BEUYW6f9.js";var E=e(t(),1),D=s();function O(){let[e,t]=(0,E.useState)(`daily`),[s,O]=(0,E.useState)(new Date().toISOString().split(`T`)[0]),[k,A]=(0,E.useState)(new Date().toISOString().split(`T`)[0]),{data:j,isLoading:M}=h(),{data:N=[],isLoading:P}=_(e===`custom`?void 0:10,e===`custom`?s:void 0,e===`custom`?k:void 0),{data:F}=m(),{data:I}=b(),{data:L}=x(),{data:R}=y(),{data:z}=T();if(M||P)return(0,D.jsx)(g,{});let B=()=>{let t=(j||[]).reduce((e,t)=>e+t.revenue,0),n=(j||[]).reduce((e,t)=>e+t.expenses,0),r=t-n,i=(I||[]).reduce((e,t)=>e+Number(t.amount),0),a=(L||[]).reduce((e,t)=>e+(t.payments||[]).reduce((e,t)=>e+Number(t.amount),0),0),o=(F||[]).filter(e=>e.payment_status===`pending`).reduce((e,t)=>e+Number(t.amount),0),c=(R||[]).filter(e=>!e.is_completed).reduce((e,t)=>e+Number(t.outstanding_amount),0),l=window.open(``,`_blank`,`noopener,noreferrer`);if(!l)return;let u=(N||[]).map(e=>`
      <tr>
        <td>${e.date}</td>
...
<body>
  ...
  <table>
    ...
    <tr><td>Pending Booking Payments</td><td>${d(o)}</td></tr>
  ...
  <h2>Daily Summary (${e===`custom`?`${s} to ${k}`:`Recent Days`})</h2>
