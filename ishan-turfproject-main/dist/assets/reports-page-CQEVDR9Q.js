import{a as e}from"./rolldown-runtime-CNC7AqOf.js";import{_ as t}from"./charts-DmA1CST9.js";import{Jt as n,Ut as r,gt as i,mt as a,rn as o,wn as s}from"./react-vendor-BrFk5xWB.js";import{a as c,i as l,n as u,s as d,t as f}from"./card-CyDGeINq.js";import{g as p,i as m,l as h,n as g,o as _,p as v}from"./index-DtVm8oSj.js";import{d as y,l as b,u as x}from"./accounts-service-Btj1t57a.js";import{i as S,r as C,t as w}from"./tabs-m0Owlu3-.js";import{n as T}from"./customers-service-CLUtgynB.js";var E=e(t(),1),D=s();function O(){let[e,t]=(0,E.useState)(`daily`),[s,O]=(0,E.useState)(new Date().toISOString().split(`T`)[0]),[k,A]=(0,E.useState)(new Date().toISOString().split(`T`)[0]),{data:j,isLoading:M}=h(),{data:N=[],isLoading:P}=_(e===`custom`?void 0:10,e===`custom`?s:void 0,e===`custom`?k:void 0),{data:F}=m(),{data:I}=b(),{data:L}=x(),{data:R}=y(),{data:z}=T();if(M||P)return(0,D.jsx)(g,{});let B=()=>{let t=(j||[]).reduce((e,t)=>e+t.revenue,0),n=(j||[]).reduce((e,t)=>e+t.expenses,0),r=t-n,i=(I||[]).reduce((e,t)=>e+Number(t.amount),0),a=(L||[]).reduce((e,t)=>e+(t.payments||[]).reduce((e,t)=>e+Number(t.amount),0),0),o=(F||[]).filter(e=>e.payment_status===`pending`).reduce((e,t)=>e+Number(t.amount),0),c=(R||[]).filter(e=>!e.is_completed).reduce((e,t)=>e+Number(t.outstanding_amount),0),l=window.open(``,`_blank`,`noopener,noreferrer`);if(!l)return;let u=(N||[]).map(e=>`
      <tr>
        <td>${e.date}</td>
