import{a as e}from"./rolldown-runtime-CNC7AqOf.js";import{_ as t}from"./charts-DmA1CST9.js";import{Gt as n,On as r,Xt as i,an as a,gt as o,mt as s}from"./react-vendor-DPVC51q6.js";import{a as c,i as l,n as u,s as d,t as f}from"./card-DDpIRClR.js";import{g as p,i as m,l as h,n as g,o as _,p as v}from"./index-CJ--xgHN.js";import{d as y,l as b,u as x}from"./accounts-service-BNRUg0ro.js";import{i as S,r as C,t as w}from"./tabs-D2FsBrgm.js";import{n as T}from"./customers-service-y1KiN4yx.js";var E=e(t(),1),D=r();function O(){let[e,t]=(0,E.useState)(`daily`),[r,O]=(0,E.useState)(new Date().toISOString().split(`T`)[0]),[k,A]=(0,E.useState)(new Date().toISOString().split(`T`)[0]),{data:j,isLoading:M}=h(),{data:N=[],isLoading:P}=_(e===`custom`?void 0:10,e===`custom`?r:void 0,e===`custom`?k:void 0),{data:F}=m(),{data:I}=b(),{data:L}=x(),{data:R}=y(),{data:z}=T();if(M||P)return(0,D.jsx)(g,{});let B=()=>{let t=(j||[]).reduce((e,t)=>e+t.revenue,0),n=(j||[]).reduce((e,t)=>e+t.expenses,0),i=t-n,a=(I||[]).reduce((e,t)=>e+Number(t.amount),0),o=(L||[]).reduce((e,t)=>e+(t.payments||[]).reduce((e,t)=>e+Number(t.amount),0),0),s=(F||[]).filter(e=>e.payment_status===`pending`).reduce((e,t)=>e+Number(t.amount),0),c=(R||[]).filter(e=>!e.is_completed).reduce((e,t)=>e+Number(t.outstanding_amount),0),l=window.open(``,`_blank`,`noopener,noreferrer`);if(!l)return;let u=(N||[]).map(e=>`
      <tr>
        <td>${e.date}</td>
...
<body>
  ...
  <h2>Daily Summary (${e===`custom`?`${r} to ${k}`:`Recent Days`})</h2>
